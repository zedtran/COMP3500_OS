...
{
  struct dw_attr_struct * const x = (struct dw_attr_struct *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_14dw_attr_struct, gt_ggc_e_14dw_attr_struct))
    {
      ...
      switch (((*x).dw_attr_val).val_class)
        ...
        case dw_val_class_vec:
          if ((*x).dw_attr_val.v.val_vec.array != NULL) {
            ...
            gt_pch_note_object ((*x).dw_attr_val.v.val_vec.array, x, gt_pch_p_14dw_attr_struct, gt_types_enum_last);
          }
          break;
        case dw_val_class_die_ref:
...
const struct ggc_root_tab gt_pch_rs_gt_dwarf2out_h[] = {
  ...
  { &have_switched_text_section, 1, sizeof (have_switched_text_section), NULL, NULL },
