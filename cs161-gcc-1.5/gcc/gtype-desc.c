  ...
  if (ggc_test_and_set_mark (x))
    {
      switch (ann_type ((tree_ann_t)&((*x))))
        ...
        case VAR_ANN:
          ...
          gt_ggc_m_6subvar ((*x).decl.subvars);
          break;
        case STMT_ANN:
  ...
  if (ggc_test_and_set_mark (x))
    {
      ...
      gt_ggc_m_15varray_head_tag ((*x).x_basic_block_info);
      gt_ggc_m_15varray_head_tag ((*x).x_label_to_block_map);
    }
}
  ...
  if (ggc_test_and_set_mark (x))
    {
      ...
      gt_ggc_m_9eh_status ((*x).saved_eh);
      ...
      gt_ggc_m_18control_flow_graph ((*x).saved_cfg);
      gt_ggc_m_9tree_node ((*x).saved_args);
      gt_ggc_m_9tree_node ((*x).saved_static_chain_decl);
      gt_ggc_m_9tree_node ((*x).saved_blocks);
      gt_ggc_m_9tree_node ((*x).saved_unexpanded_var_list);
      gt_ggc_m_9tree_node ((*x).decl);
  ...
  if (gt_pch_note_object (x, x, gt_pch_p_10tree_ann_d, gt_ggc_e_10tree_ann_d))
    {
      switch (ann_type ((tree_ann_t)&((*x))))
        ...
        case VAR_ANN:
          ...
          gt_pch_n_6subvar ((*x).decl.subvars);
          break;
        case STMT_ANN:
  ...
  if (gt_pch_note_object (x, x, gt_pch_p_18control_flow_graph, gt_ggc_e_18control_flow_graph))
    {
      ...
      gt_pch_n_15varray_head_tag ((*x).x_basic_block_info);
      gt_pch_n_15varray_head_tag ((*x).x_label_to_block_map);
    }
}
  ...
  if (gt_pch_note_object (x, x, gt_pch_p_8function, gt_ggc_e_8function))
    {
      ...
      gt_pch_n_9eh_status ((*x).saved_eh);
      ...
      gt_pch_n_18control_flow_graph ((*x).saved_cfg);
      gt_pch_n_9tree_node ((*x).saved_args);
      gt_pch_n_9tree_node ((*x).saved_static_chain_decl);
      gt_pch_n_9tree_node ((*x).saved_blocks);
      gt_pch_n_9tree_node ((*x).saved_unexpanded_var_list);
      gt_pch_n_9tree_node ((*x).decl);
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).cfg), cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).saved_cfg), cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).saved_args), cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).saved_static_chain_decl), cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).saved_blocks), cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).saved_unexpanded_var_list), cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).decl), cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).outer), cookie);
