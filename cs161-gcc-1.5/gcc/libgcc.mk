srcdir = /home/blakedonzac/cs161/cs161-gcc-1.5/./gcc-4.1.2+cs161/gcc
VPATH = /home/blakedonzac/cs161/cs161-gcc-1.5/./gcc-4.1.2+cs161/gcc
EQ = =
objects = $(filter %.o,$^)
...
libgcc/./unwind-dw2.o: stmp-dirs /home/blakedonzac/cs161/cs161-gcc-1.5/./gcc-4.1.2+cs161/gcc/unwind-dw2.c unwind.inc unwind-dw2-fde.h unwind-dw2-fde.c $(CONFIG_H) coretypes.h $(TM_H) $(MACHMODE_H) longlong.h config.status stmp-int-hdrs tsystem.h
	$(GCC_FOR_TARGET) $(LIBGCC2_CFLAGS) $(INCLUDES) $(vis_hide) -fexceptions -c /home/blakedonzac/cs161/cs161-gcc-1.5/./gcc-4.1.2+cs161/gcc/unwind-dw2.c -o libgcc/./unwind-dw2.o
./libgcc.a: libgcc/./unwind-dw2.o
libgcc/./unwind-dw2-fde-glibc.o: stmp-dirs /home/blakedonzac/cs161/cs161-gcc-1.5/./gcc-4.1.2+cs161/gcc/unwind-dw2-fde-glibc.c unwind.inc unwind-dw2-fde.h unwind-dw2-fde.c $(CONFIG_H) coretypes.h $(TM_H) $(MACHMODE_H) longlong.h config.status stmp-int-hdrs tsystem.h
	$(GCC_FOR_TARGET) $(LIBGCC2_CFLAGS) $(INCLUDES) $(vis_hide) -fexceptions -c /home/blakedonzac/cs161/cs161-gcc-1.5/./gcc-4.1.2+cs161/gcc/unwind-dw2-fde-glibc.c -o libgcc/./unwind-dw2-fde-glibc.o
./libgcc.a: libgcc/./unwind-dw2-fde-glibc.o
libgcc/./unwind-sjlj.o: stmp-dirs /home/blakedonzac/cs161/cs161-gcc-1.5/./gcc-4.1.2+cs161/gcc/unwind-sjlj.c unwind.inc unwind-dw2-fde.h unwind-dw2-fde.c $(CONFIG_H) coretypes.h $(TM_H) $(MACHMODE_H) longlong.h config.status stmp-int-hdrs tsystem.h
	$(GCC_FOR_TARGET) $(LIBGCC2_CFLAGS) $(INCLUDES) $(vis_hide) -fexceptions -c /home/blakedonzac/cs161/cs161-gcc-1.5/./gcc-4.1.2+cs161/gcc/unwind-sjlj.c -o libgcc/./unwind-sjlj.o
./libgcc.a: libgcc/./unwind-sjlj.o
libgcc/./gthr-gnat.o: stmp-dirs /home/blakedonzac/cs161/cs161-gcc-1.5/./gcc-4.1.2+cs161/gcc/gthr-gnat.c unwind.inc unwind-dw2-fde.h unwind-dw2-fde.c $(CONFIG_H) coretypes.h $(TM_H) $(MACHMODE_H) longlong.h config.status stmp-int-hdrs tsystem.h
	$(GCC_FOR_TARGET) $(LIBGCC2_CFLAGS) $(INCLUDES) $(vis_hide) -fexceptions -c /home/blakedonzac/cs161/cs161-gcc-1.5/./gcc-4.1.2+cs161/gcc/gthr-gnat.c -o libgcc/./gthr-gnat.o
./libgcc.a: libgcc/./gthr-gnat.o
libgcc/./unwind-c.o: stmp-dirs /home/blakedonzac/cs161/cs161-gcc-1.5/./gcc-4.1.2+cs161/gcc/unwind-c.c unwind.inc unwind-dw2-fde.h unwind-dw2-fde.c $(CONFIG_H) coretypes.h $(TM_H) $(MACHMODE_H) longlong.h config.status stmp-int-hdrs tsystem.h
	$(GCC_FOR_TARGET) $(LIBGCC2_CFLAGS) $(INCLUDES) $(vis_hide) -fexceptions -c /home/blakedonzac/cs161/cs161-gcc-1.5/./gcc-4.1.2+cs161/gcc/unwind-c.c -o libgcc/./unwind-c.o
...
libgcc-stage-start:
	for dir in $(dirs); do \
	  if [ -d $(stage)/$$dir ]; then :; \
	  else /bin/sh /home/blakedonzac/cs161/cs161-gcc-1.5/./gcc-4.1.2+cs161/gcc/../mkinstalldirs $(stage)/$$dir; fi; \
	done
	-for dir in $(dirs); do \
	  mv $$dir/*.o $(stage)/$$dir; \
...
stmp-dirs:
	for d in $(dirs); do \
	  if [ -d $$d ]; then true; else /bin/sh /home/blakedonzac/cs161/cs161-gcc-1.5/./gcc-4.1.2+cs161/gcc/../mkinstalldirs $$d; fi; \
	done
