...
#define MASK_FIX_R4000 (1 << 7)
#define MASK_FIX_R4400 (1 << 8)
#define MASK_FP_EXCEPTIONS (1 << 9)
#define MASK_FLOAT64 (1 << 10)
#define MASK_FUSED_MADD (1 << 11)
#define MASK_64BIT (1 << 12)
#define MASK_MIPS16 (1 << 13)
#define MASK_MIPS3D (1 << 14)
#define MASK_LONG64 (1 << 15)
#define MASK_PAIRED_SINGLE_FLOAT (1 << 16)
#define MASK_SINGLE_FLOAT (1 << 17)
#define MASK_SOFT_FLOAT (1 << 18)
#define MASK_SPLIT_ADDRESSES (1 << 19)
#define MASK_VR4130_ALIGN (1 << 20)
